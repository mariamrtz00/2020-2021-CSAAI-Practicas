...
img.onload = function () {
  ...
  let i = 200 + 50*canvas.width; //obtenemos el número de pixel con esto a partir de su posición en xy
  //let i= 100 + 50*canvas.width;
  //-- Pixel rojo: canal rojo a tope. Resto de colores a 0
  //-- La transparencia no se modifica
  data[i*4] = 255;    //-- Canal Rojo // rojo a tope y resto a 0S
